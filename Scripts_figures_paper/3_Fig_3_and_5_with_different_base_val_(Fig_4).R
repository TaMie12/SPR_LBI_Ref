...
### File: 3_Fig_3-4_with_different_base_val.R
### Time-stamp: <2021-08-30 11:15:40 a23579>
###
      ...
      function(x)
{
    ...
    ggsave(filename = paste0("MK-CV_",
                             ifelse(multLc == 1,
                                    paste0("Lm=Lc=", multLm, "Linf"),
                                    paste0("Lm=", multLm, "Linf_Lc=",
                                           multLc, "Lm")),
                             ".", deviceType),
           plot = plot.CVMK, device = deviceType, path = outDir,
           height = he, width = wi ,
           units = "mm", dpi=300)
    ...
    ggsave(filename = paste0(ifelse(multLm==0.7 & multLc==0.5,
                                    "Fig_4_", ""),
                             "Sensitivity_",
                             ifelse(multLc == 1,
                                    paste0("Lm=Lc=", multLm, "Linf"),
                                    paste0("Lm=", multLm, "Linf_Lc=",
                                           multLc, "Lm")),
                             ".", deviceType),
           plot = plot.grSensit2, device=deviceType, path= outDir,
           height = he, width = wi,
           units = "mm", dpi=300)
