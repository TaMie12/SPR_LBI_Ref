...
### File: 1_Lmax5refpoints-LHT_rel.R
### Time-stamp: <2021-08-30 11:15:54 a23579>
###
### Created: 05/10/2017	17:49:39
### Authors: Yves Reecht, Tanja Miethe
###
####################################################################################################
### Description:
###
...
deviceType <- "tiff"                    # What output format for graphics?
                                        #   see ?ggsave(device = ...)
...
ggsave(filename = paste0("Fig_5_MK-CV.", deviceType),
       plot = plot.CVMK,
       device = deviceType, path = outDir,
       height = he, width = wi,
       units = "mm", dpi=300)
...
ggsave(filename = paste0("Fig_3_Sensitivity.", deviceType),
       plot = plot.grSensit2,
       device = deviceType, path = outDir,
       height = he,
       width = wi,
