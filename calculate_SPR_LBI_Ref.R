...
### based on Miethe et al. (2019) using either determinsitic equations as given in paper (with CVLinf=0, knife-edge selectivity and maturity ogive)
### or using the simulation tool in R-library LBSPR with setting CVLinf and define selectivity and maturity ogives
###
...
# returns Lmax5% RP and unfished value (UF, F=0), Lmean RP and unfished value estimated using LBSPR, unfished values (UF), F/M and F at 40%SPR, M/k, SPR used:
res1<- Lmax5_Lmean_LBSPR1(Linf=Linf, M=M, k=k, Wbeta=b, Lm50=Lmat, Ls50 = Lc, SPRref=SPRref)
